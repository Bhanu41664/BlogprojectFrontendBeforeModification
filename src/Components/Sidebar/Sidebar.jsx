  ...
  return (
    <div className='sidebar'>
      <div className="sidebarItem">
        ...
        />
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab similique nisi illum, provident at id! Error similique vitae cum laborum est delectus earum tempore sint et, ducimus esse expedita consequatur.</p>
      </div>
      <div className="sidebarItem">
        <span className="sidebarTitle" >
         CATEGORIES  
